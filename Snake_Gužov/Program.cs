	...
	class Program
	{
		static void Main(string[] args)
		{
			...
			while (true)
			{
				...
				{
					snake.Move();//по иному движемся дальше (отрисовываем новые точки хвоста и удаляем точки головы заменя новыми в том же направлении в каком двигались до этого)
				}
